...
####################
# >>> selected
# Index(['Megamonas', 'Lactobacillus', 'Gemella', 'Peptostreptococcus',
#        'Parvimonas', 'Romboutsia', 'Porphyromonas', 'Ruthenibacterium',
#        'Limosilactobacillus', 'Ralstonia'],
#       dtype='object')
# >>> 
...
plt.savefig(
    "ROC_Control_vs_LoCRC_Publication.png",
    dpi=600,
    bbox_inches="tight",
    facecolor="white"
)
